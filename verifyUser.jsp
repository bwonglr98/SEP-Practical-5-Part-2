...
<%
    String userID = request.getParameter("userID");  //*** read in the values from the form object using the request object getParameter() method
...
<body>
    ...
    try {
          ...
          String sqlStr = "";  //*** SELECT prepare statement here
